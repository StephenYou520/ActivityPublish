    ...
    <div class=" uk-grid" style="margin-top: 30px">
        <div class="uk-width-3-4">
            ...
            <%
                ...
                FindactbyUsername mysign =new FindactbyUsername();





                ResultSet showmysign = mysign.getactbysuername(user);
                ...
                while(showmysign.next()){
                    ...
                    out.write("<h3><a href='../activities/activityDetails.jsp?id="+showmysign.getObject(2).toString()+"'>" + showmysign.getObject(1).toString() + "</a></h3>");
                    out.write("<p>" + "活动时间："+showmysign.getObject(3).toString()+ "</p>");
                    out.write("<p>" + "活动地点："+showmysign.getObject(4).toString()+ "</p>");
