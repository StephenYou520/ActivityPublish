...
<%@ page import="myserverlet.FindactbyUsername" %>
<%@page import="myserverlet.Findonbyusername" %>
<%@page import="myserverlet.Findendbyusername" %>
    ...
    <div class=" uk-grid" style="margin-top: 30px">
        <div class="uk-width-3-4">
            ...
            <%
               ...
               Findendbyusername finder =new Findendbyusername();





                ResultSet rst = finder.getact(user);
                ...
                while(rst.next()){
                    ...
                    out.write("<h3><a href='../activities/mypubDetails.jsp?id="+rst.getObject(2).toString()+"'>" + rst.getObject(1).toString() + "</a></h3>");
                    out.write("<p>" + "活动时间："+rst.getObject(3).toString()+ "</p>");
                    out.write("<p>" + "活动地点："+rst.getObject(4).toString()+ "</p>");
